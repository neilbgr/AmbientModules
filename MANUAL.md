...
|---|---|---|
| [Lunar50Drone](#lunar50drone) | Drone voices 1, 2, 4, 5 "Classic Solar 50" | 5-oscillator sawtooth drone with a shared envelope |
| [LunarVCO](#lunarvco) | Voices "VCO A / VCO B" | AS3340-style VCO with ADSR and hard sync |
| [LunarLFO](#lunarlfo) | LFOs | Dual unipolar triangle/square LFO |
| [LunarPapaSrapa](#lunarpapasrapa) | Drone voices 3, 6 "Papa Srapa" | FM/AM cross-modulated noise/drone voice |
| [LunarSequencer](#lunarsequencer) | Sequencer | 5-stage Buchla-inspired CV/gate sequencer |
...
The full rack of AmbientModules modules, side by side, in each of the 5 available themes (see [Panel themes](#panel-themes)).
